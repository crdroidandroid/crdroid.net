      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-6">
          <div class="feature-block">
            ...
            <p>It's really simple. Just message Gabriel over <a href="https://telegram.me/gwolf2u" target="_blank"><span class="fab fa-telegram" style="font-size: 14px;"></span> Telegram</a> with the device you want to maintain. Note that we only support Pie builds for devices.</p>
          </div>
        </div>
