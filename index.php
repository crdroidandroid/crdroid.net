          ...
          <ul>
            <li class="FAQ-element">
              ...
              <div id="accordion-list-1" class="collapse show" data-bs-parent=".accordion-list">
                <p>
                So you want to make your build official and become a crDroid maintainer?<br> Just head over to our GitHub in order to get more info. <br>Note that we only support Android 13 builds for new devices.<br>
                </p>
