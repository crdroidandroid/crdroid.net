...
<head>
  ...
  <script>
      ...
      (function(){
          ...
          if(Math.random() < 0.05) {if (window.dataLayer && (window.dataLayer.some(e => e[0] === 'js' && e[1] instanceof Date) || window.dataLayer.some(e => e['event'] === 'gtm.js' && e['gtm.start'] == true ))) {document.head.appendChild(document.createElement('img')).src = "//clickiocdn.com/utr/gtag/?sid=232010";}}
      })();
  </script>
	  ...
	  <div class="section-title">
        ...
        <div class="col-md col-lg">
			<div class="col-md-12">    
				...
				<h3>TERMS OF USE</h3>
				<p>Certain images, logos, pictures, and other works originating with organizations other than crDroid may be or are the trademarks and/or servicemarks of those other organizations and are subject to the laws of their registered countries. crDroid’ usage constitutes a ‘fair use’ of any such copyrighted material as provided for in section 107 of the US Copyright Law. If you wish to use copyrighted material from this site for purposes of your own that go beyond ‘fair use’, you must obtain permission from the copyright owner. Requests for removal of copyright material may be sent to <a href="mailto:contact@crdroid.net" target="_blank">contact@crdroid.net</a>.</p>

				<h2>Privacy Policy</h2>
				<p>Your privacy is important to crDroid. Our Privacy Policy explains how we collect, use, disclose, transfer, and store your information. Please take a moment to familiarize yourself with our privacy practices.</p>

				<p>crDroid provides an after-market operating system and applications for various mobile devices.</p>

				<h3>INFORMATION WE HAVE</h3>
				<p>Certain information (e.g. a device unique anonymized ID, device model, etc.) is transmitted to us solely for the purpose of measuring non-personally identifiable installation metrics. Unless otherwise stated below, this information is not used for any other purpose.</p>
				...
				<h3>OPT-OUT</h3>
				<p>You may opt-out of crDroid device statistics at install time from the setup wizard or after install via the Privacy menu in Settings on the device.</p>

				<h3>WEB</h3>
				<p>As is true of most websites, we gather some information automatically and store it in log files. This information includes Internet Protocol (IP) addresses, browser type (and version) and language, Internet service provider (ISP), referring and exit pages, operating system, date/time stamp, and clickstream data.</p>

				<p>We may collect information regarding user activities on our website and from our other products and services. This information is aggregated and used to help us provide more useful information to our users to understand which parts of our website, products, and services are of most interest, and for general system diagnostics. Aggregated data is considered non-personal information for the purposes of this Privacy Policy.</p>

				<p>We do not knowingly collect personal information from children under 13 except where a parent has set up an account for their child and provided crDroid with verified parental consent. If we learn that we have collected the personal information of a child under 13 without first receiving verifiable parental consent we will take steps to delete the information as soon as possible.</p>

				<h3>INFORMATION WE MAY SHARE</h3>
				<p>We do not share your information with companies, organizations, or individuals outside of crDroid unless one of the following circumstances applies:</p>

				<ul>
				<li>With your consent (Submission of bug reports to our bug tracking platform is considered consent.)</li>
				<li>When legally required.</li>
				</ul>

				<p>We will share the information we have with entities outside of crDroid if we have a good faith belief that access, use, preservation, or disclosure of the information is necessary to:</p>
				...
				<li>protect against harm to the rights, property, or safety of crDroid, our users, or the public as required or permitted by law.</li>
				</ul>
